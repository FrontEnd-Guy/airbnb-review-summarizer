  ...
  return (
    <article className="about">
      ...
      <p>
        ...
        essays. This capability comes from training on vast datasets. For instance, ChatGPT has been
        trained on 570 gigabytes of text from sources like books, articles, and blogs—amounting to
        hundreds of billions of words. An LLM predicts the next word by assigning probabilities to
        different word options, or 'tokens,' and selects the most probable one. This selection is
        influenced by a parameter known as 'temperature,' which dictates the predictability or
